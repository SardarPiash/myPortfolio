    ...
    return (
        <div className="container mx-auto p-0 max-w-[100%] md:max-w-[960px] lg:max-w-[1000px] ">
            ...
            <div className="px-2 py-[25px] mt-[10px] md:py-0 md:mt-[40px] lg:mt-[55px]">
                ...
                <h1 className="text-[30px] md:text-[60px] lg:text-[70px] font-bold text-white">Abu Shaleh Md. Kaium</h1>

                <h2 className="text-[35px] md:text-[40px] lg:text-[35px] font-bold text-gray-400 tracking-tight lg:w-full">
                ...
                <a
                    ...
                    className="inline-block mt-12 px-8 py-6 border border-white text-white  rounded"
                >
                    <div className=" flex" style={{}}>
                    <div><img src={CV} alt="cv icon" /></div>
