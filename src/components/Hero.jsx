    ...
    return (
        <div className="container mx-auto p-0 max-w-[100%] md:max-w-[1152px] ">
            ...
            <div className="px-2 py-[25px] mt-[10px] md:py-0 md:mt-[40px] lg:mt-[55px]  md:ml-[13px]">
                <p className="text-base md:text-base lg:text-base text-[#D3D3D3]" >Hi, I'm</p>

                <h1 className="text-[30px] md:text-[50px]  font-bold text-softBlack">Abu Shaleh Md. Kaium</h1>

                <h2 className="text-[35px] md:text-[30px] font-bold text-softBlue tracking-tight lg:w-full">
                Code meets creativity <span className=" text-softBlue">|</span> Bringing creativity to life through code.
                </h2>
                ...
                <button
                onClick={() => window.open('https://drive.google.com/file/d/167eNXtPWZecJWF-D4yyZ4zMFf43fRVli/view?usp=sharing', '_blank')}
